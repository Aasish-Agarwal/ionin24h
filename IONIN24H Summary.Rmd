...
summarize_voting_by_location(report_df = report_df)
```
...
summarize_voting_by_area(report_df = report_df)
```
...
summarize_innovators( report_df = report_df )
...
get_potential_participants (voters = voters, report_df = report_df) 
